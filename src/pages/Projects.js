...
const projectContents = {
        ...
        <p>
          <ul>
            <li>
              ...
              can identify spam timport {Link} from "react-router-dom";weets
              with <b>{">"}95% accuracy</b> (LSTM, Transformer, SVM and Naive
              Bayes), provided insights into each model’s strengths and
              shortcomings.
            </li>
            <li>
  ...
  4: {
    short: (
      <p>
        Tell you your age in percentage, which may shock you a bit. Helpful
        resources are provided in case you need it :) I hope through this new
        len, you will think about your life differently. <b>#TypeScript</b>.
      </p>
    ),
    long: (
      <p>
  ...
  6: {
    short: (
      <p>
        ...
        according to pre-defined access codes. I applied MERN architecture,
        designed suitable database schemas, implemented a multitude of API
        endpoints and written fully automated unit tests.
      </p>
    ),
    long: (
      <p>
        <ul>
          <li>
            An app built for getting survey answers and allows customised
            content according to pre-defined access codes.
          </li>
          <li>
