...
const TimeIHaveLeft = () => {
  ...
  const calculatePercentage = (monthsLeft: number): string => {
    let percentage: number =
      (1 - monthsLeft / (ASSUMED_LIFE_EXPECTANCY * 12)) * 100;
  ...
  const calculateTimeLeft = () => {
    ...
    const yearsLeft =
      ASSUMED_LIFE_EXPECTANCY - (currentDate.getFullYear() - dob.getFullYear());
  ...
  return (
    <div className="container time-i-have-left">
      ...
      <>
        <p>
          If you can live up to 80 years old, assumingly don't get any genetec
          adjustments or have your body frozen, and survive through maybe a few
          more financial crises, social revolutions, artificial intelligent
          impact, cancers, epidemics, then...
        </p>
        <p>
        ...
        {over100yoMessage === "" ? (
          <p>
            Oh maybe minus the last 10 useless weak-ass years of your life as
        ...
        <p>
          Through this new len of looking at life expectancy, I hope you now
          think about your life a bit differently.{" "}
        </p>
      ...
      <ul>
        ...
        <li>
          Eat healthy food and Exercise regularly, you may be able to delay
          aging 10 more years
        </li>
